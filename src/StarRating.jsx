...
export default function StarRating({
  ...
  /* We generally do not want the initial state to be based off of a prop, but this is only if the propr itself will be updated later 
  in this case the defaultRating will stay consistent so we do not need to worry about using a prop as the intial state.*/
